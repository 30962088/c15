...
public class WHMeasureImageView extends ImageView {


	public WHMeasureImageView(Context context) {
		super(context);
	}

	public WHMeasureImageView(Context context, AttributeSet attrs) {
