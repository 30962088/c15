...
import com.mengle.android.library.R;
...
public class CircleLayout extends ViewGroup {
	...
	public CircleLayout(Context context, AttributeSet attrs) {
		...
		try {
			int dividerColor = a.getColor(R.styleable.CircleLayout_sliceDivider, getResources().getColor(android.R.color.darker_gray));
